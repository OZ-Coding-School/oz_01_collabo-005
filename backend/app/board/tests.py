...
class ScheduleModelTest(TestCase):
    ...
    def test_create_schedule_without_title(self) -> None:
        data = {
            "content": "test",
            "event_time": "2024-04-30 13:51:00.000000",
            "place": "test place",
    ...
    def test_create_schedule_without_content(self) -> None:
        data = {
            "title": "test title",
            "event_time": "2024-04-30 13:51:00.000000",
            "place": "test place",
    ...
    def test_create_schedule_without_event_time(self) -> None:
        data = {
            "title": "test title",
            "content": "test",
            "place": "test place",
    ...
    def test_create_schedule_without_place(self) -> None:
        data = {
            "title": "test title",
            "content": "test",
            "event_time": "2024-04-30 13:51:00.000000",
