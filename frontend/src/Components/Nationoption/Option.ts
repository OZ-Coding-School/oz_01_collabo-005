export const Option = [
  ...
  { value: "Netherlands, Kingdom of the", name: "Netherlands, Kingdom of the" },
  ...
  { value: "Palestine, State of[b]", name: "Palestine, State of[b]" },
  ...
  { value: "South Africa", name: "South Africa" },
  {
    ...
    name: "South Georgia and the Sout Sandwich Islands",
  },
  ...
  { value: "Svalbard and Jan Mayen[e]", name: "Svalbard and Jan Mayen[e]" },
